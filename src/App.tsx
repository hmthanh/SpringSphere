...
function Bauble({ vec = new THREE.Vector3(), scale, r = THREE.MathUtils.randFloatSpread }) {
  ...
  return (
    <RigidBody linearDamping={0.75} angularDamping={0.15} friction={0.2} position={[r(20), r(20) - 25, r(20) - 10]} ref={api as any} colliders={false} dispose={null}>
...
function Pointer({ vec = new THREE.Vector3() }) {
  ...
  return (
    <RigidBody position={[100, 100, 100]} type="kinematicPosition" colliders={false} ref={ref as any}>
      <BallCollider args={[2]} />
    </RigidBody>
  )
}
